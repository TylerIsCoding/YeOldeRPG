...
class Game:
    ...
    def combat_text_speed(self):
        ...
        Utility.clear()
        Utility.line("############################")
        Utility.line("#       Combat Speed       #")
        Utility.line("############################")
        Utility.line("        1.) Normal")
        Utility.line("        2.) Fast Scroll")
        Utility.line("        3.) Instant")
        Utility.line("         (R)eturn")
        answer = input('\n\n>>> ')
        if str(1) in answer:
    ...
    def confirmation(self):
        ...
        TextSpeed.line(f'{a:^24}')
        TextSpeed.line("########################")
        TextSpeed.line(f"Hit Points: {self.myPlayer.hp}/{self.myPlayer.max_hp}")
        TextSpeed.line(f"Mana Points: {self.myPlayer.mp}")
        TextSpeed.line(f"Defence: {self.myPlayer.defense}")
        TextSpeed.line(f"Attack Dice: {self.myPlayer.max_attack_str}")
        TextSpeed.line("\n#######| Skills |#######\n")
        for skill in self.myPlayer.skills:
            TextSpeed.line(f'{skill.name}')
        TextSpeed.line("\n\n########################")
        TextSpeed.line("\n\nRe-roll? (Y)es or (N)o")
        answer_3 = input("\n\n>>> ")
        if "n" in answer_3:
